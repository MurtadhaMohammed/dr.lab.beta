...
function drawWatermark(doc, { logoBase64 }) {
  ...
  if (doc.setGState) doc.setGState(new doc.GState({ opacity: PDF_CFG.brand.watermarkOpacity }));
  doc.addImage(`data:image/png;base64,${logoBase64}`, "PNG", x, y, logoWidth, logoHeight, undefined, "FAST");
